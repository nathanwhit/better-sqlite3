...
#define NODE_GETTER(name)                                                      \
  static void name(v8::Local<v8::String> _,                                    \
                   const v8::PropertyCallbackInfo<v8::Value> &info)
#else
#define NODE_GETTER(name)                                                      \
  static void name(v8::Local<v8::Name> _,                                      \
                   const v8::PropertyCallbackInfo<v8::Value> &info)
#endif
#define INIT(name)                                                             \
  static v8::Local<v8::Function> name(v8::Isolate *isolate,                    \
...
inline v8::Local<v8::String> StringFromUtf8(v8::Isolate *isolate,
...
InternalizedFromUtf8(v8::Isolate *isolate, const char *data, int length) {
  return v8::String::NewFromUtf8(isolate, data,
                                 v8::NewStringType::kInternalized, length)
      .ToLocalChecked();
}
inline v8::Local<v8::Value>
InternalizedFromUtf8OrNull(v8::Isolate *isolate, const char *data, int length) {
  if (data == NULL)
    return v8::Null(isolate);
  return InternalizedFromUtf8(isolate, data, length);
}
inline v8::Local<v8::String> InternalizedFromLatin1(v8::Isolate *isolate,
                                                    const char *str) {
...
inline void SetFrozen(v8::Isolate *isolate, v8::Local<v8::Context> ctx,
...
inline void ThrowRangeError(const char *message) {
  EasyIsolate;
  isolate->ThrowException(
...
NewConstructorTemplate(v8::Isolate *isolate, v8::Local<v8::External> data,
                       v8::FunctionCallback func, const char *name) {
...
inline void SetPrototypeMethod(v8::Isolate *isolate,
                               v8::Local<v8::External> data,
                               v8::Local<v8::FunctionTemplate> recv,
                               const char *name, v8::FunctionCallback func) {
...
inline void SetPrototypeSymbolMethod(v8::Isolate *isolate,
                                     v8::Local<v8::External> data,
                                     v8::Local<v8::FunctionTemplate> recv,
...
inline void SetPrototypeGetter(v8::Isolate *isolate,
                               v8::Local<v8::External> data,
                               v8::Local<v8::FunctionTemplate> recv,
                               const char *name,
                               v8::AccessorNameGetterCallback func) {
